# Social Services Agency - Business Scenario

##Please create a T SQL script for this business scenario. Create the table, insert the sample data and write the queries for the reports.
